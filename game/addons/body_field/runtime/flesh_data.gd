...
## Holds parsed data from a Version-2 .bin file produced by the Blender addon.
## Coordinates are already in Godot Y-up world space — no axis conversion needed.
##
## Format (little-endian):
##   [Magic 'FLSH' u8×4] [version u32 = 2]
...
##   [render_influence f32 Nr]     — 0=bone-only, 1=full sim
##
## See `docs/body_field/flesh_deformer_v2_legacy.md` §".bin File Format".
